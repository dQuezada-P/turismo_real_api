...
export const emailConfirmAccount = (data) => {
  ...
  const msg = {
    ...
    <p style="text-align: center;"><a href='http://52.91.212.222:3001/confirmar-cuenta?token=${token}' style="font-family: Georgia; color: #ffffff; font-size: 20px; padding: 10px; text-decoration: none; -webkit-border-radius: 30px; -moz-border-radius: 30px; border-radius: 30px; -webkit-box-shadow: 0px 1px 3px #666666; -moz-box-shadow: 0px 1px 3px #666666; box-shadow: 0px 1px 3px #666666; text-shadow: 1px 1px 3px #666666; border: solid #87428e 1px; background: #87428e;">Confirmar Correo</a></p>
    <p></p>`
  }
