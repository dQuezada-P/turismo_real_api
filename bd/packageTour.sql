...
AS
BEGIN
    OPEN V_TOURS FOR SELECT T.ID,T.CIUDAD,T.CUPO,T.PRECIO,T.HORARIO,T.DESCRIPCION,T.ID_LOCALIDAD,L.NOMBRE FROM TOUR T JOIN LOCALIDAD L ON(T.ID_LOCALIDAD = L.ID);
    END;
