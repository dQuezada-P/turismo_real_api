...
AS
    ...
    AS
    BEGIN
        INSERT INTO DEPARTAMENTO VALUES(DEPARTAMENTO_AUTO.NEXTVAL,V_NOMBRE,V_NUMERO_BANNO,V_NUMERO_HABITACION,TO_DATE(V_FECHA,'DD-MM-YYYY HH24:MI:SS'),V_DIRECCION,V_VALOR,V_LOCALIDAD,V_DESCRIPCION);  
