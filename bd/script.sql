...
CREATE TABLE CHECKOUT(
    ...
    DESCRIPCION VARCHAR2(60),
    SUBTOTAL_INCONVENIENTES NUMBER 
);
...
--------------------------------------------------------------------------------------
INSERT INTO USUARIO VALUES('18937755-K','CLAUDIO','ABELE','https://pbs.twimg.com/profile_images/825896631132422144/XG4CZU8N_400x400.jpg','CL.DUOC@DUOCUC.CL','Y','TU CASA','9-12345678','123','1');

INSERT INTO USUARIO VALUES('20141805-4','NICOLAS','CASTILLO','https://pbs.twimg.com/profile_images/825896631132422144/XG4CZU8N_400x400.jpg','NI.CASTILLOL@DUOCUC.CL','N','LA CASA DEL','9-12345678','123','2');
...
--------------------------------------------------------------------------------------
INSERT INTO DEPARTAMENTO (ID,NOMBRE,NUMERO_BANNO,NUMERO_HABITACION,DIRECCION,VALOR_ARRIENDO,ID_LOCALIDAD,DESCRIPCION,ESTADO_DISPONIBLE,ESTADO_RESERVA,IMAGEN)
...
--------------------------------------------------------------------------------------
INSERT INTO RESERVA(ID,FECHA_INICIO,FECHA_SALIDA,CANTIDAD_PERSONA,ID_CLIENTE,ID_DEPARTAMENTO,ID_SERVICIO,ID_CHECKIN,ID_CHECKOUT) VALUES(RESERVA_AUTO.NEXTVAL,'22-08-22 12:00:00','23-08-22 12:00:00',2,'18937755-K',1,1,1,1);
create or replace TRIGGER CREAR_CHECKS
    ...
    BEGIN
        ID_RESERVA := :NEW.ID;
        INSERT INTO CHECKIN (ID,FECHA_CONTRATO,HORA_DE_ENTRADA) VALUES(ID_RESERVA,:new.FECHA_INICIO,:new.FECHA_INICIO);
        INSERT INTO CHECKOUT (ID,FECHA_CONTRATO,HORA_DE_SALIDA) VALUES(ID_RESERVA,:NEW.FECHA_SALIDA,:NEW.FECHA_SALIDA);
