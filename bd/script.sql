...
--------------------------------------------------------------------------------------
INSERT INTO DEPARTAMENTO (ID,NOMBRE,NUMERO_BANNO,NUMERO_HABITACION,FECHA_INS,DIRECCION,VALOR_ARRIENDO,ID_LOCALIDAD,DESCRIPCION,ESTADO_DISPONIBLE,ESTADO_RESERVA)
VALUES(DEPARTAMENTO_AUTO.NEXTVAL,'DEPTO BASICO',1,2,'22-08-22','MI CASA',5000,1,'TURISTAS',TRUE,FALSE);

INSERT INTO DEPARTAMENTO (ID,NOMBRE,NUMERO_BANNO,NUMERO_HABITACION,FECHA_INS,DIRECCION,VALOR_ARRIENDO,ID_LOCALIDAD,DESCRIPCION,ESTADO_DISPONIBLE,ESTADO_RESERVA)
VALUES(DEPARTAMENTO_AUTO.NEXTVAL,'DEPTO BASICO 2',1,1,'22-08-22','MI CASA',4000,2,'TURISTAS',TRUE,FALSE);

INSERT INTO DEPARTAMENTO (ID,NOMBRE,NUMERO_BANNO,NUMERO_HABITACION,FECHA_INS,DIRECCION,VALOR_ARRIENDO,ID_LOCALIDAD,DESCRIPCION,ESTADO_DISPONIBLE,ESTADO_RESERVA)
VALUES(DEPARTAMENTO_AUTO.NEXTVAL,'DEPTO BASICO 3',2,2,'22-08-22','MI CASA',7000,3,'TURISTAS',TRUE,FALSE);
